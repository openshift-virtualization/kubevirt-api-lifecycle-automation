# Introduction
Sometimes one would want to setup KUBEVIRT API LIFECYCLE AUTOMATION JOB on a totally external cluster (not kubevirtci).  
...
# Build and push images, create manifests and deploy kubevirt api lifecycle automation job
...
export KUBEVIRT_API_LIFECYCLE_AUTOMATION_NAMESPACE=kubevirt-api-lifecycle-automation-rand-ns-name
export KUBECONFIG=/path/to/kubeconfig
# Make kubevirt-api-lifecycle-automation repositories public on your registry
...
- You will be prompted to login to your external registry,
  ...
  Bazel push (kubevirt-api-lifecycle-automation containers/e2e testing containers) expects external registry creds to be in the docker CRI default path.
